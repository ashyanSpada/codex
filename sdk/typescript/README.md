...
The TypeScript SDK wraps the `codex` CLI from `@ashyan/codex_plus`. It spawns the CLI and exchanges JSONL events over stdin/stdout.

## Installation

```bash
npm install @ashyan/codex_plus-sdk
```
...
```typescript
import { Codex } from "@ashyan/codex_plus-sdk";
