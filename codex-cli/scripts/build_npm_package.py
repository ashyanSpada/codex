#!/usr/bin/env python3
"""Stage and optionally package the @ashyan/codex_plus npm module."""
...
CODEX_NPM_NAME = "@ashyan/codex_plus"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `@ashyan/codex_plus`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@ashyan/codex_plus-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@ashyan/codex_plus-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@ashyan/codex_plus-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@ashyan/codex_plus-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@ashyan/codex_plus-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@ashyan/codex_plus-win32-arm64",
        "npm_tag": "win32-arm64",
