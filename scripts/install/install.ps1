...
function Get-ReleaseAssetMetadata {
    ...
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/ashyanSpada/codex/releases/tags/rust-v$ResolvedVersion"
...
function Resolve-Version {
    ...
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/ashyanSpada/codex/releases/latest"
...
function Maybe-HandleConflictingInstall {
    ...
    $uninstallArgs = if ($manager -eq "bun") {
        @("remove", "-g", "@ashyan/codex_plus")
    } else {
        @("uninstall", "-g", "@ashyan/codex_plus")
    }
